...
const indexTestUnique = "CREATE UNIQUE INDEX %s_%s_unique_%s ON people USING %s (%s);"
const indexTestNotUnique = "CREATE INDEX %s_%s_notunique_%s ON people USING %s (%s);"
const indexTestDropUnique = "DROP INDEX %s_%s_unique_%s;"
const indexTestDropNotUnique = "DROP INDEX %s_%s_notunique_%s;"
